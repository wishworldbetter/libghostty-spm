...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/wishworldbetter/libghostty-spm/releases/download/storage.1.3.12/GhosttyKit.xcframework.zip",
            checksum: "8ed414a6fb007f94e2fa6111ad9ecaa39aef1dcfc2e2bbb1889bb4b883ad2b34"
        ),
        .testTarget(
            name: "GhosttyKitTest",
