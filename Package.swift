...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/wishworldbetter/libghostty-spm/releases/download/storage.1.3.14/GhosttyKit.xcframework.zip",
            checksum: "0be5806133dd449707be2b1d010258a4c21f222901829d1ca3728657dfe40ee9"
        ),
        .testTarget(
            name: "GhosttyKitTest",
