...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/wishworldbetter/libghostty-spm/releases/download/storage.1.3.8/GhosttyKit.xcframework.zip",
            checksum: "04bbdfc4a9f8c0c950abd84d7cf64646171b56170f133cd38aaf85eff9ee6d63"
        ),
        .testTarget(
            name: "GhosttyKitTest",
